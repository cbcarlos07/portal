...
<html>
    ...
    <div id="tablelist" >
        ...
        <table width="100%">
                        <tr id="title">
                            <td colspan="9" align="center" bgcolor="#a4cbf6" >Serviços Recebidos Por Usu&aacute;rio Conclu&iacute;dos - <font color="blue"><?php echo $user;?> </font></td>
                        </tr>
                        <tr id="titulo">

                            <td>Item</td><td>Oficina</td><td>C&oacute;digo</td><td>Setor</td><td>Descri&ccedil;&atilde;o do Servi&ccedil;o</td>
                            <td>Solicitante</td><td>Data da Solcita&ccedil;&atilde;o</td>
                        </tr>
                        <?php
